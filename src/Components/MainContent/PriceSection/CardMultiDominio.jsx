...
const CardMultiDominio = () => {
    ...
    return (
        <div className="w-{clac(90%)} lg:w-full shadow-2xl lg:mt-72 rounded-3xl  bg-white/50 p-4 z-10">
            ...
            <div>
                <button className='bg-orange-400  text-white font-semibold text-lg lg:text-xl rounded-xl lg:rounded-[calc(30px)] w-full lg:h-[calc(98px)] h-[calc(39px)] mt-1'>Contattaci</button>
            </div>
        </div>
    )
}
